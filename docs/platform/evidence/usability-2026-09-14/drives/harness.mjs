...
//   node docs/platform/evidence/usability-2026-09-14/drives/<drive>.mjs
...
export const OUT = process.env.OUT_DIR ?? resolve(process.cwd(), 'tests/visual/artifacts/usability-2026-09-14');
