...
Before PR creation, main advanced to `43f1024359bdbca7320bf807f1890541763e83ad` through the scheduled daily/Registry snapshots. Those upstream commits were merged unchanged; the allowance was repinned to that exact PR base. No calculation, feature or maintenance dependency changed. Hosted CI validates the combined tree. Local typecheck completed with 0 errors and 0 warnings (12 hints).
