/**
 * Run the partition cross-runtime cases in Node, on the bytes in
 * `pack.bin`.
 *
 *   node node-run.mjs
 *
 ...
 * and the digest this runtime computed is the one that goes into the plan
 * key it publishes.
 */
