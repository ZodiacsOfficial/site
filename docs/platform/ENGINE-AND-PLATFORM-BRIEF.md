...
| 3.7 | **CLI:** `npx @zodiacs/cli chart | positions | events | verify | conformance`, with text, JSON and SVG output and receipts; offline by default. | clean-consumer install on Linux, macOS and Windows |
