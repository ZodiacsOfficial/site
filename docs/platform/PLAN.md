...
| 9 | A04/C02 contract/receipts | Portable same-calculation receipts #425 and explicit local downloads #427 pass all14 CI jobs and exact previews. Rich immutable records #426 remain inactive pending lifecycle integration. Chart/context ownership #434 preserves committed writes and propagates clearing. C-014 is delivered in #435: 5,024 tests,35 native/20 Moon/17 chart controls,24 actual localized page cases,18 unchanged captures and ten preview groups pass. Next C-015 withholds unproved unknown-time Moon candidates and the endpoint-derived singular Sun Registry link while preserving reference numerical/receipt bytes. Author implementation and independent counterexample/consumer reviews run in isolated scopes. Moon phase/reference captions, downstream reference-Sun semantics, complete date coverage and range/degenerate-angle review remain open. |
