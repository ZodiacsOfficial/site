...
| 7 | B01/B02 discovery/integrations | B01 implemented and local build/check/desktop/mobile/CSS-zoom checks passed. B02 starter rc.2 passes 24 fresh-consumer tests; finish corrected mobile/widget browser checks, anonymous public download, onboarding page and separate stacked draft PR. Internal timing is not external adoption. |
