...
| 9 | A04/C02 contract/receipts | Next bounded slice: reject impossible imported civil dates/clock rollover before legacy-share calculation; a synthetic reproduction confirms false DST-gap normalization. Then define reviewed date/range and degenerate-angle policy; inspect existing Chart types/export schemas before adding validators. Preserve requested/actual houses, runtime timezone provenance and unknown-time flags; redact diagnostics. |
