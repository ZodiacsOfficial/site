...
`;var Te="123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz",ot=new Map([...Te].map((e,t)=>[e,BigInt(t)]));function Pe(){return globalThis.CustomEvent}function he(e,t=window){let n=new Set,i=()=>e([...n].sort((s,p)=>s.name.localeCompare(p.name))),c=Object.freeze({register:(...s)=>{for(let p of s)p?.features?.["standard:connect"]&&n.add(p);return i(),()=>{for(let p of s)n.delete(p);i()}}}),d=(s=>{let p=s.detail;typeof p=="function"&&p(c)});t.addEventListener("wallet-standard:register-wallet",d);let o=Pe();return t.dispatchEvent(new o("wallet-standard:app-ready",{detail:c})),i(),()=>t.removeEventListener("wallet-standard:register-wallet",d)}var Le="solana:mainnet",Ne="solana:signTransaction";function I(){let e=new Error("The wallet was dismissed.");return e.name="WalletDismissed",e}function ge(e){return e?e.name==="WalletDismissed"||e.code===4001||e.code===-32603?!0:/reject|refus|denied|declin|cancel|dismiss|user closed/i.test(String(e.message??"")):!1}function De(e){let t=atob(e),n=new Uint8Array(t.length);for(let i=0;i<t.length;i+=1)n[i]=t.charCodeAt(i);return n}function Me(e){let t="";for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}function Be(e,t){return[...(t?.accounts?.length?t.accounts:e.accounts)??[]].find(i=>!i.chains?.length||i.chains.some(c=>c.startsWith("solana:")))??null}function ze(e,t){return e.length===1?Promise.resolve(e[0]):new Promise((n,i)=>{let c=document.createElement("div");c.className="tp-pick";let d=document.createElement("div");d.className="tp-pick__box",d.setAttribute("role","dialog"),d.setAttribute("aria-modal","true"),d.setAttribute("aria-label","Choose a wallet");let o=document.createElement("p");o.className="tp-pick__title",o.textContent="Choose a wallet",d.append(o);let s=()=>{c.remove(),document.removeEventListener("keydown",p)},p=a=>{a.key==="Escape"&&(s(),i(I()))};for(let a of e){let h=document.createElement("button");if(h.type="button",h.className="tp-pick__w",a.icon){let b=document.createElement("img");b.src=a.icon,b.alt="",b.width=24,b.height=24,h.append(b)}h.append(document.createTextNode(a.name)),h.addEventListener("click",()=>{s(),n(a)}),d.append(h)}let u=document.createElement("button");u.type="button",u.className="tp-pick__x",u.textContent="Cancel",u.addEventListener("click",()=>{s(),i(I())}),d.append(u),c.addEventListener("click",a=>{a.target===c&&(s(),i(I()))}),document.addEventListener("keydown",p),c.append(d),(t?.ownerDocument??document).body.append(c),d.querySelector("button")?.focus()})}function be({host:e=null,target:t=void 0,choose:n=void 0}={}){let i=[],c=he(s=>{i=s},t??window),d=n??(s=>ze(s,e)),o=null;return{getAddress(){return o?.account.address??null},async connect(){if(o)return o.account.address;if(!i.length)throw new E("unavailable","No Solana wallet was found in this browser.");let s=await d(i),p;try{p=await s.features["standard:connect"].connect()}catch(a){throw ge(a)?I():a}let u=Be(s,p);if(!u)throw new E("unavailable","That wallet has no Solana account.");return o={wallet:s,account:u},u.address},async signTransaction(s){if(!o)throw new E("unavailable","No wallet is connected.");let p=o.wallet.features[Ne];if(!p)throw new E("unavailable","That wallet cannot sign here.");let u;try{u=await p.signTransaction({transaction:De(s),account:o.account,chain:Le})}catch(h){throw ge(h)?I():h}let a=u?.[0]?.signedTransaction;if(!a)throw new E("unavailable","The wallet returned nothing to submit.");return Me(a)},destroy(){c(),o=null}}}var $e=Object.freeze(["card","usdc"]),Ie=Object.freeze(["idle","quoting","ready","signing","done","error"]),W="EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v",Y=6,We=6,qe=Object.freeze(["25","50","100","250"]),Fe=Object.freeze([{name:"Coinbase",mark:"coinbase",href:"https://www.coinbase.com/",note:"Dollars to USDC, no trading fee."},{name:"fomo",mark:"fomo",href:"https://fomo.family/",applePay:!0,note:"Apple Pay, trades in the app."},{name:"MoonPay",mark:"moonpay",href:"https://www.moonpay.com/",note:"Cards and bank transfer."},{name:"Ramp Network",mark:"ramp",href:"https://rampnetwork.com/",note:"Cards, Apple Pay, Google Pay."}]);function Ue(e){let t=Number(e);return Number.isFinite(t)?t<1?`${Math.round(t*100)}\xA2`:`$${t.toFixed(2)}`:""}function Oe(e,t=We){let n=ce(e,t,{maxFractionDigits:0});return Number(n).toLocaleString("en-US",{maximumFractionDigits:0})}function Re(e,t){let n=(Number(e)||0)*((Number(t)||0)/1e4);return`Jupiter\u2019s fee \u2014 about ${Ue(n)} on this trade.`}function je(e){let t=le(e),n=Math.abs(Number(e)||0).toFixed(2);return{band:t,text:`Buying this much moves the price ${n}%.`,severe:t==="severe"}}function He(e,t){let n=Math.abs(Number(t)||0).toFixed(2);return`Not much ${e} is for sale right now, so buying this much would push the price up ${n}%. Buying less costs you less.`}function Ve(e){return e==="card"?"Whichever you pick, the payment and any ID checks happen with that company \u2014 Zodiacs.org never sees your card and never holds your money. Prices here move fast, and a Zodiac can lose all its value.":"Your wallet will ask you to approve this before anything happens. Jupiter does the trade, not us \u2014 Zodiacs.org never holds your money and can\u2019t undo a trade once it\u2019s made. Prices here move fast, and a Zodiac can lose all its value."}function Ge(e){return["They are in your wallet already. Nobody else can move them \u2014 not us, not Jupiter.","You do not need to do anything else. There is nothing to claim and nothing to renew.","Sell them whenever you like, the same way you bought them.",`${e} now shows in your Cabinet of Twelve.`]}function Je(e){switch(e){case"no_route":return"No price right now. Try again in a moment, or try a smaller amount.";case"rate_limited":return"Too many requests just now. Wait a moment and try again.";case"invalid_amount":return"Enter an amount using digits and a single decimal point.";case"order_mismatch":case"unexpected_fee":return"The price that came back did not match what you were shown, so nothing was sent to your wallet. Try again.";case"execute_failed":return"The trade did not go through. Nothing left your wallet.";case"network":return"That could not be confirmed from here. Check your wallet before trying again \u2014 it may still have gone through.";default:return"Something went wrong. Nothing was sent to your wallet."}}function xe({state:e="idle",payMethod:t="card",sign:n,amount:i="25",quote:c=null,error:d=null}){if(!Ie.includes(e))throw new Error(`panel-model: unknown state ${e}`);if(!$e.includes(t))throw new Error(`panel-model: unknown pay method ${t}`);let o={state:e,payMethod:t,heading:`${n.name}`,subheading:`The official ${n.name} token`,venue:"Bought through Jupiter",payLabel:"You pay",payUnit:"USDC",payHint:"US dollars, held as USDC",presets:qe,amount:i,methods:[{id:"card",label:"Card or Apple Pay"},{id:"usdc",label:"USDC I already have"}],payWays:Fe,note:Ve(t),showQuote:!1,showAction:e!=="done",facts:[],warning:null,error:null,after:null};if(e==="error")return o.error=Je(d),o;if(e==="done")return o.after=Ge(n.name),o.note="Zodiacs.org never held your keys or funds, and cannot reverse a trade.",o;if(e==="quoting")return o.getLabel="You get",o.actionLabel="Finding the best price\u2026",o.actionDisabled=!0,o;if(c){let s=je(c.priceImpactPct);o.showQuote=!0,o.getLabel="You get, about",o.receive=Oe(c.outAmount),o.receiveUnit=n.name,o.receiveWorth=c.outUsdValue?`worth about $${c.outUsdValue.toFixed(2)} right now`:"",o.facts=[Re(i,c.feeBps),s.text],o.impactBand=s.band,s.severe&&(o.warning=He(n.name,c.priceImpactPct))}return o.actionLabel=e==="signing"?"Approve it in your wallet":"Review in your wallet",o.actionDisabled=e==="signing",o.walletHint="No wallet yet? Phantom and Solflare are free, and hold what you buy.",o}var Qe=100,Ye=350;function Ze(e,t){if(!e||e<=0n)return!1;let n=e*BigInt(1e4-Qe)/10000n;return t<n}function ye({sign:e,deps:t,amount:n="25",payMethod:i="card"}){let{fetchOrder:c,executeOrder:d,wallet:o,onChange:s,setTimeout:p=setTimeout,clearTimeout:u=clearTimeout}=t,a={state:"idle",payMethod:i,amount:n,quote:null,error:null,signature:null,awaitingReview:!1},h=0,b=null,v=!1,w=()=>{v||s?.(N(),{...a})},N=()=>xe({state:a.state,payMethod:a.payMethod,sign:e,amount:a.amount,quote:a.quote,error:a.error});function _(x){a.state="error",a.error=x instanceof E?x.code:"unknown",a.quote=null,w()}async function D(){if(v)return;let x=++h,A;try{A=J(a.amount,Y)}catch(y){_(y);return}a.state="quoting",a.error=null,w();try{let y=await c({inputMint:W,outputMint:e.mint,amount:A});if(x!==h)return;Q(y,{inputMint:W,outputMint:e.mint,amount:A}),a.quote=y,a.state="ready",w()}catch(y){if(x!==h)return;_(y)}}function q(x){a.amount=String(x),a.awaitingReview=!1,b&&u(b),b=p(()=>{b=null,D()},Ye),w()}function F(x){a.payMethod=x,w()}async function M(){if(v||a.state==="signing")return;let x;try{x=J(a.amount,Y)}catch(y){_(y);return}let A=a.quote?.outAmount??null;a.state="signing",a.error=null,w();try{let y=o.getAddress()||await o.connect(),k=await c({inputMint:W,outputMint:e.mint,amount:x,taker:y});if(Q(k,{inputMint:W,outputMint:e.mint,amount:x}),!ue(k))throw new E("unavailable","The venue returned no transaction.");if(Ze(A,k.outAmount)){a.quote=k,a.state="ready",a.awaitingReview=!0,w();return}let B=await o.signTransaction(k.transaction),S=await d({signedTransaction:B,requestId:k.requestId});a.quote=k,a.signature=S.signature,a.state="done",w()}catch(y){if(y?.name==="WalletDismissed"){a.state=a.quote?"ready":"idle",w();return}_(y)}}function U(){v=!0,h+=1,b&&u(b),b=null}return{get state(){return{...a}},view:N,setAmount:q,setPayMethod:F,refreshQuote:D,review:M,destroy:U}}var T="tp";function l(e,t,n){let i=document.createElement(e);return t&&(i.className=t),n!=null&&(i.textContent=n),i}function ve(e,t){let n=l("span",`${T}__mark`);return n.setAttribute("aria-hidden","true"),n.style.width=`${t}px`,n.style.maskImage=`url(${e})`,n.style.webkitMaskImage=`url(${e})`,n}function Ke(e,t){let n=l("a",null,t);return n.href=e,n.target="_blank",n.rel="noopener noreferrer external nofollow",n}function we({host:e,sign:t,deps:n,marks:i={}}){let c=l("div",T);c.style.setProperty("--tp-sign",t.hue);let d=l("div",`${T}__head`);if(t.iconUrl){let r=document.createElement("img");r.className=`${T}__disc`,r.src=t.iconUrl,r.alt="",r.width=34,r.height=34,d.append(r)}let o=l("span",`${T}__who`),s=l("span",`${T}__name`),p=l("span",`${T}__sub`);o.append(s,p);let u=l("span",`${T}__venue`);d.append(o,u);let a=l("div",`${T}__body`),h=l("span","lab"),b=l("div","pay"),v=document.createElement("input");v.className="pay__input",v.inputMode="decimal",v.spellcheck=!1,v.setAttribute("aria-label","Amount in US dollars");let w=l("span","unit");b.append(v,w);let N=l("p","sub"),_=l("div","amts");_.setAttribute("role","group"),_.setAttribute("aria-label","Choose an amount");let D=l("div","meet");D.innerHTML='<i></i><span aria-hidden="true">\u2193</span><i></i>';let q=l("span","lab"),F=l("div","get"),M=l("span","out"),U=l("span","unit");F.append(M,U);let x=l("p","usd"),A=l("div","quote");A.setAttribute("aria-live","polite"),A.append(q,F,x);let y=l("div","facts"),k=l("p","warn");k.hidden=!0;let B=l("p","lab payq","How are you paying?"),S=l("div","payseg");S.setAttribute("role","group"),S.setAttribute("aria-label","How are you paying");let O=l("div","action"),L=l("button","tp__go");L.type="button";let Z=l("p","nowallet"),G=l("div","routes"),R=l("p","err");R.hidden=!0;let j=l("ul","after");j.hidden=!0;let K=l("p","note");a.append(h,b,N,_,D,A,y,k,B,S,O,R,j,K),c.append(d,a),e.replaceChildren(c);let X=()=>{},P=ye({sign:t,deps:{...n,onChange:r=>X(r)}}),ee=null,te=null;function ne(r){s.textContent=r.heading,p.textContent=r.subheading,u.textContent=r.venue,h.textContent=r.payLabel,w.textContent=r.payUnit,N.textContent=r.payHint,document.activeElement!==v&&(v.value=r.amount),ee!==r.presets&&(_.replaceChildren(...r.presets.map(m=>{let g=l("button",null,`$${m}`);return g.type="button",g.dataset.amount=m,g})),ee=r.presets);for(let m of _.children)m.setAttribute("aria-pressed",String(m.dataset.amount===r.amount));te!==r.methods&&(S.replaceChildren(...r.methods.map(m=>{let g=l("button",null,m.label);return g.type="button",g.dataset.method=m.id,g})),te=r.methods);for(let m of S.children)m.setAttribute("aria-pressed",String(m.dataset.method===r.payMethod));A.hidden=!r.showQuote&&r.state!=="quoting",q.textContent=r.getLabel||"",M.textContent=r.showQuote?r.receive:"",U.textContent=r.showQuote?r.receiveUnit:"",x.textContent=r.showQuote?r.receiveWorth:"",M.classList.toggle("is-waiting",r.state==="quoting"),y.replaceChildren(...(r.facts||[]).map((m,g)=>{let z=l("span","fact",m);return g===1&&r.impactBand==="severe"&&z.classList.add("severe"),z})),k.hidden=!r.warning,k.textContent=r.warning||"",R.hidden=!r.error,R.textContent=r.error||"",j.hidden=!r.after,r.after&&j.replaceChildren(...r.after.map(m=>l("li",null,m))),K.textContent=r.note;let C=r.payMethod==="card";O.replaceChildren(),r.showAction&&!r.error&&(C?O.append(Ee(r,i)):(L.textContent=r.actionLabel,L.disabled=!!r.actionDisabled,Z.textContent=r.walletHint||"",O.append(L,Z))),B.hidden=!r.showAction||!!r.error,S.hidden=B.hidden}function Ee(r,C){G.replaceChildren();let m=l("ul","ramps");for(let g of r.payWays){let z=l("li"),H=Ke(g.href,"");H.className="ramp",H.setAttribute("aria-label",`${g.name} \u2014 opens in a new tab`);let V=l("span","ramp__who");if(C[g.mark]&&V.append(ve(C[g.mark],22)),V.append(l("span","ramp__name",g.name)),g.applePay&&C.applepay){let $=ve(C.applepay,36);$.className="tp__mark ap",$.setAttribute("role","img"),$.setAttribute("aria-label","Apple Pay"),$.removeAttribute("aria-hidden"),V.append($)}H.append(V,l("span","ramp__note",g.note),l("span","go","\u2197")),z.append(H),m.append(z)}return G.append(m),G}let re=()=>P.setAmount(v.value),oe=r=>{let C=r.target.closest("[data-amount]");C&&P.setAmount(C.dataset.amount)},ae=r=>{let C=r.target.closest("[data-method]");C&&P.setPayMethod(C.dataset.method)},ie=()=>P.review();return v.addEventListener("input",re),_.addEventListener("click",oe),S.addEventListener("click",ae),L.addEventListener("click",ie),X=ne,ne(P.view()),P.refreshQuote(),{controller:P,destroy(){v.removeEventListener("input",re),_.removeEventListener("click",oe),S.removeEventListener("click",ae),L.removeEventListener("click",ie),P.destroy(),e.replaceChildren()}}}var _e="data-tp-styles",Xe=Object.freeze({coinbase:"/assets/venues/coinbase.svg",fomo:"/assets/venues/fomo.svg",moonpay:"/assets/venues/moonpay.svg",ramp:"/assets/venues/ramp.svg",applepay:"/assets/venues/applepay.svg"});function et(){if(document.querySelector(`[${_e}]`))return;let e=document.createElement("style");e.setAttribute(_e,""),e.textContent=fe,document.head.append(e)}function Ce(e,t){if(!e||!t?.mint)return null;et();let n=be({host:e}),i=we({host:e,sign:t,deps:{fetchOrder:pe,executeOrder:me,wallet:n},marks:Xe});return{controller:i.controller,destroy(){i.destroy(),n.destroy()}}}function ke(){for(let e of document.querySelectorAll("[data-trade-panel]")){let t=e.dataset.tradeSign;!t||e.dataset.tradeMounted||(e.dataset.tradeMounted="1",Ce(e,{name:e.dataset.tradeName??t,slug:t,mint:e.dataset.tradeMint,hue:e.dataset.tradeHue||null,iconUrl:`/assets/zodiac-icons/128/${t}.webp`}))}}window.zodiacsTrade=Object.freeze({mount:Ce});document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ke,{once:!0}):ke();})();
