...
`;function wt(r){let t=1/0,e=-1/0;for(let n of r)n.l<t&&(t=n.l),n.h>e&&(e=n.h);if(!Number.isFinite(t)||!Number.isFinite(e))return null;if(t===e){let n=t===0?1:Math.abs(t)*.05;return{min:t-n,max:e+n}}let a=(e-t)*.08;return{min:Math.max(0,t-a),max:e+a}}function kt(r){let t=0;for(let e of r)e.v>t&&(t=e.v);return t}function At(r,t,e=4){if(!(t>r)||e<1)return[];let a=t-r,n=10**Math.floor(Math.log10(a/(e+1))),i=n*10;for(let c of[1,2,5,10])if(a/(n*c)<=e+1){i=n*c;break}let p=[];for(let c=Math.ceil(r/i)*i;c<=t;c+=i)p.push(c);return p}function St(r,t){if(r<=0||t<=0)return{step:0,bodyWidth:0,centers:[]};let e=t/r,a=Math.max(1,Math.min(e*.68,13)),n=[];for(let i=0;i<r;i+=1)n.push(e*i+e/2);return{step:e,bodyWidth:a,centers:n}}function et(r,t,e){let a=t.max-t.min;return a<=0?e/2:e-(r-t.min)/a*e}function Tt(r,t,e){if(t<=0||e<=0||r<0||r>=e)return null;let a=Math.floor(r/e*t);return a>=0&&a<t?a:null}function Et(r,t,e=6){if(!r.length)return[];let a=[],n=Math.max(1,Math.ceil(r.length/e));for(let i=0;i<r.length;i+=n)a.push(i);return a}function D(r){let t=Number(r);if(!Number.isFinite(t))return"—";if(t===0)return"0";let e=Math.max(0,3-Math.floor(Math.log10(Math.abs(t))));return t.toLocaleString("en-US",{minimumFractionDigits:0,maximumFractionDigits:Math.min(e,12)})}function ht(r){let t=Number(r);return Number.isFinite(t)?Math.abs(t)>=1e3?`$${t.toLocaleString("en-US",{maximumFractionDigits:0})}`:`$${t.toLocaleString("en-US",{minimumFractionDigits:2,maximumFractionDigits:2})}`:"—"}function Ct(r){let t=Number(r);return Number.isFinite(t)?t>=1e3?t.toLocaleString("en-US",{maximumFractionDigits:0}):t.toLocaleString("en-US",{maximumFractionDigits:2}):"—"}var yt=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];function ft(r,t){let e=new Date(r*1e3);if(Number.isNaN(e.getTime()))return"—";if(t==="1d")return`${e.getUTCDate()} ${yt[e.getUTCMonth()]}`;let a=String(e.getUTCHours()).padStart(2,"0"),n=String(e.getUTCMinutes()).padStart(2,"0");return`${e.getUTCDate()} ${yt[e.getUTCMonth()]} ${a}:${n}`}function Mt(r,t){let e=Math.max(0,Math.round((t-r)/1e3));if(e<60)return`${e}s ago`;let a=Math.floor(e/60);if(a<60)return`${a}m ago`;let n=Math.floor(a/60);return n<24?`${n}h ago`:`${Math.floor(n/24)}d ago`}var Nt=74,Rt=22,ie=.16;var ut="#8E96AB",oe="rgba(198,204,218,0.10)",se="rgba(198,204,218,0.22)",pe="11px 'JetBrains Mono', ui-monospace, monospace";function Ot({canvas:r,readout:t}){let e=r.getContext("2d"),a=[],n="1h",i=ut,p=null;function c(){let h=r.getBoundingClientRect();return{width:h.width,height:h.height}}function d(){let{width:h,height:v}=c();if(h<=0||v<=0)return;let x=window.devicePixelRatio||1;if((r.width!==Math.round(h*x)||r.height!==Math.round(v*x))&&(r.width=Math.round(h*x),r.height=Math.round(v*x)),e.setTransform(x,0,0,x,0,0),e.clearRect(0,0,h,v),!a.length)return;let L=h-Nt,R=v-Rt,Q=Math.round(R*ie),O=R-Q-6,S=wt(a);if(!S)return;let{bodyWidth:y,centers:k}=St(a.length,L),j=kt(a);e.font=pe,e.textBaseline="middle";for(let g of At(S.min,S.max)){let f=et(g,S,O);e.strokeStyle=oe,e.beginPath(),e.moveTo(0,f+.5),e.lineTo(L,f+.5),e.stroke(),e.fillStyle=ut,e.textAlign="left",e.fillText(D(g),L+8,f)}if(j>0)for(let g=0;g<a.length;g+=1){let f=a[g],E=Math.max(1,f.v/j*Q);e.fillStyle=f.c>=f.o?`${i}55`:"rgba(142,150,171,0.30)",e.fillRect(k[g]-y/2,R-E,y,E)}for(let g=0;g<a.length;g+=1){let f=a[g],E=k[g],G=f.c>=f.o,P=G?i:ut,U=et(f.h,S,O),M=et(f.l,S,O),$=et(f.o,S,O),K=et(f.c,S,O);e.strokeStyle=P,e.lineWidth=1,e.beginPath(),e.moveTo(E+.5,U),e.lineTo(E+.5,M),e.stroke();let X=Math.min($,K),W=Math.max(1,Math.abs(K-$));G?(e.fillStyle=P,e.fillRect(E-y/2,X,y,W)):e.strokeRect(E-y/2+.5,X+.5,y-1,Math.max(1,W-1))}e.fillStyle=ut,e.textAlign="center";for(let g of Et(a,n)){let f=ft(a[g].ts,n),E=Math.min(Math.max(k[g],24),L-24);e.fillText(f,E,v-Rt/2)}if(p!==null&&a[p]){let g=k[p];e.strokeStyle=se,e.setLineDash([3,3]),e.beginPath(),e.moveTo(g+.5,0),e.lineTo(g+.5,R),e.stroke(),e.setLineDash([])}}function l(){if(!t)return;let h=p!==null?a[p]:a[a.length-1];if(!h){t.textContent="";return}t.textContent=[ft(h.ts,n),`O ${D(h.o)}`,`H ${D(h.h)}`,`L ${D(h.l)}`,`C ${D(h.c)}`,`Vol $${D(h.v)}`].join("  ")}function s(h){let v=r.getBoundingClientRect(),x=Tt(h.clientX-v.left,a.length,v.width-Nt);x!==p&&(p=x,d(),l())}function _(){p=null,d(),l()}r.addEventListener("pointermove",s),r.addEventListener("pointerleave",_);let z=typeof ResizeObserver=="function"?new ResizeObserver(()=>d()):null;return z?.observe(r),{set({candles:h,timeframe:v,hue:x}){a=Array.isArray(h)?h:[],v&&(n=v),x&&(i=x),p=null,d(),l()},clear(){a=[],p=null,d(),l()},destroy(){z?.disconnect(),r.removeEventListener("pointermove",s),r.removeEventListener("pointerleave",_)}}}var Pt="https://api.geckoterminal.com/api/v2";var le="zodiacs.exchange.gecko-budget.v1",ce="zodiacs.exchange.gecko-cooloff.v1",Be=Object.freeze(["network","rate_limited","unavailable","not_indexed"]),rt=class extends Error{constructor(t,e,{cause:a,retryAfterMs:n=null}={}){super(e,a?{cause:a}:void 0),this.name="ExchangeDataError",this.code=t,this.retryAfterMs=Number.isFinite(n)&&n>=0?n:null}};function H(r,t,e){throw new rt(r,t,e)}var ue=Object.freeze({"15m":{path:"minute",aggregate:15,limit:192},"1h":{path:"hour",aggregate:1,limit:168},"4h":{path:"hour",aggregate:4,limit:180},"1d":{path:"day",aggregate:1,limit:180}});function de({pool:r,timeframe:t,baseUrl:e=Pt}){let a=ue[t];a||H("unavailable",`Unknown timeframe: ${t}`);let n=new URL(`${e}/networks/solana/pools/${encodeURIComponent(r)}/ohlcv/${a.path}`);return n.searchParams.set("aggregate",String(a.aggregate)),n.searchParams.set("limit",String(a.limit)),n.toString()}function me({pool:r,baseUrl:t=Pt}){return new URL(`${t}/networks/solana/pools/${encodeURIComponent(r)}/trades`).toString()}function he(r){(!r?.data||typeof r.data!="object")&&H("unavailable","The chart data was not readable.");let t=r.data.attributes?.ohlcv_list;if(t===void 0)return[];Array.isArray(t)||H("unavailable","The chart data was not readable.");let e=[];for(let a of t){if(!Array.isArray(a)||a.length<6)continue;let[n,i,p,c,d,l]=a.map(Number);[n,i,p,c,d,l].every(Number.isFinite)&&(n<=0||i<=0||p<=0||c<=0||d<=0||l<0||e.push({ts:n,o:i,h:p,l:c,c:d,v:l}))}return e.sort((a,n)=>a.ts-n.ts),e}function fe(r,t){let e=r?.data;Array.isArray(e)||H("unavailable","The trade data was not readable.");let a=[];for(let n of e){let i=n?.attributes;if(!i)continue;let p=Date.parse(i.block_timestamp??"");if(!Number.isFinite(p))continue;let c,d;if(i.to_token_address===t)c=Number(i.to_token_amount),d=Number(i.price_to_in_usd);else if(i.from_token_address===t)c=Number(i.from_token_amount),d=Number(i.price_from_in_usd);else continue;let l=i.kind==="buy"||i.kind==="sell"?i.kind:null,s=Number(i.volume_in_usd);!l||!Number.isFinite(c)||c<=0||!Number.isFinite(d)||d<=0||a.push({id:String(n.id??`${i.tx_hash}-${p}`),ts:p,side:l,tokenAmount:c,priceUsd:d,volumeUsd:Number.isFinite(s)?s:null,tx:typeof i.tx_hash=="string"?i.tx_hash:null})}return a.sort((n,i)=>i.ts-n.ts),a}function qt({limit:r=12,windowMs:t=6e4,now:e=()=>Date.now(),storage:a=null,storageKey:n=le}={}){let i=[],p=!!a;function c(){if(!p)return i;try{let l=JSON.parse(a.getItem(n)??"[]");if(Array.isArray(l))return l.filter(Number.isFinite)}catch{p=!1}return i}function d(l){if(i=l,!!p)try{a.setItem(n,JSON.stringify(l))}catch{p=!1}}return{take(){let l=e(),s=l-t,_=c().filter(z=>z>s&&z<=l);return _.length>=r?(d(_),!1):(_.push(l),d(_),!0)}}}function ge(r,{now:t=()=>Date.now(),maxMs:e=12e4}={}){if(typeof r!="string"||!r.trim())return null;let a=r.trim(),n=Number(a);if(Number.isFinite(n)&&n>=0)return Math.min(Math.ceil(n*1e3),e);let i=Date.parse(a);return Number.isFinite(i)?Math.min(Math.max(0,i-t()),e):null}async function Dt(r,{fetchImpl:t=globalThis.fetch,signal:e,deadlineMs:a=12e3}={}){let n=new AbortController,i=!1,p=()=>n.abort();e?.aborted?p():e?.addEventListener("abort",p,{once:!0});let c=setTimeout(()=>{i=!0,n.abort()},a);try{let d;try{d=await t(r,{method:"GET",signal:n.signal,headers:{accept:"application/json"}})}catch(l){if(e?.aborted||(i&&H("network","The chart service timed out.",{cause:l}),l?.name==="AbortError"))throw l;H("network","The chart service could not be reached just now.",{cause:l})}d.status===429&&H("rate_limited","The chart service is rate limiting requests.",{retryAfterMs:ge(d.headers?.get?.("retry-after")??null)}),d.status===404&&H("not_indexed","This pool is not indexed by the chart service."),d.ok||H("unavailable","The chart service did not answer.");try{return await d.json()}catch(l){if(e?.aborted||(i&&H("network","The chart service timed out.",{cause:l}),l?.name==="AbortError"))throw l;H("unavailable","The chart service did not return a readable answer.",{cause:l})}}finally{clearTimeout(c),e?.removeEventListener("abort",p)}}function zt({baseMs:r=1e4,maxMs:t=12e4,now:e=()=>Date.now(),storage:a=null,storageKey:n=ce}={}){let i={until:0,step:0,revision:0},p=!!a;function c(){if(!p)return i;try{let l=JSON.parse(a.getItem(n)??"null");l&&[l.until,l.step,l.revision].every(Number.isFinite)&&(i=l)}catch{p=!1}return i}function d(l){if(i=l,!!p)try{a.setItem(n,JSON.stringify(l))}catch{p=!1}}return{active(){return e()<c().until},remainingMs(){return Math.max(0,c().until-e())},token(){return c().revision},fail(l=null){let s=c(),_=Math.min(r*2**s.step,t),z=Number.isFinite(l)?Math.min(Math.max(0,l),t):0,h=e()+Math.max(_,z);d({until:Math.max(s.until,h),step:s.step+1,revision:s.revision+1})},ok(l=null){let s=c();return l!==null&&l!==s.revision?!1:(d({until:0,step:0,revision:s.revision+1}),!0)}}}async function Lt({pool:r,timeframe:t,baseUrl:e,fetchImpl:a,signal:n,deadlineMs:i}){let p=await Dt(de({pool:r,timeframe:t,baseUrl:e}),{fetchImpl:a,signal:n,deadlineMs:i});return he(p)}async function Ut({pool:r,mint:t,baseUrl:e,fetchImpl:a,signal:n,deadlineMs:i}){let p=await Dt(me({pool:r,baseUrl:e}),{fetchImpl:a,signal:n,deadlineMs:i});return fe(p,t)}var be={aries:"HRn98YLGigP475eS1GaQYRMbqk1V4dkV6tdKyLhVh2iS",taurus:"2GNtxia4fLW3URj5MLqVfgoKrAgDpphtAVazK41eTPfu",gemini:"HxhdKrB1UpSwfuMoZMVzPVELzbPWHdyN6PHU9CBFium9",cancer:null,leo:"48ErBGMqiZekyLoCcebd7cS5KNQPzqr7QQAK9mzAPQGQ",virgo:"5WcVjf8fzPkHaZqTSZDdbDFL6p2bLbAgEigxpevNrcRh",libra:"DTXPQjK4ae4h2Wc7D5Rpij8YmSQxqLuTcNKrpBCjcAN9",scorpio:"3d2KYuMgj2yotNC6SKX4HNoeSWp4n8zqZSQ9kFH81Yta",sagittarius:null,capricorn:"549aknNCvxbiqmikS6sAnY6Dbg37MeENWn6ZFBfc7sin",aquarius:"BygCEAhCNyWC8Co9yPa4K84NGkgkgMWdib2FG5hhuiUv",pisces:"Fzz8QrSV8sPKsTtHocwYARE8Zo6Rd4Wv2Ee4JtCuiDko"};function _e(r,t){if(!Array.isArray(r)||!t)return null;let e=null,a=-1;for(let n of r){if(n?.chainId!=="solana"||!n?.pairAddress||n?.baseToken?.address!==t)continue;let i=Number(n?.liquidity?.usd);!Number.isFinite(i)||i<=0||i>a&&(a=i,e=String(n.pairAddress))}return e}function $t({slug:r,mint:t,rows:e}){return be[r]??_e(e,t)}function It(r,t){let e=String(t||"");if(!e||!Array.isArray(r))return null;let a=new Set,n=0;for(let i of r){if(i?.chainId!=="solana"||i?.baseToken?.address!==e)continue;let p=String(i?.pairAddress||"");if(!p||a.has(p))continue;let c=Number(i?.liquidity?.usd);!Number.isFinite(c)||c<=0||(a.add(p),n+=c)}return n>0?n:null}var Ft="https://api.dexscreener.com/tokens/v1/solana";function xe(r,t=Ft){return`${t}/${r.map(e=>encodeURIComponent(e)).join(",")}`}function ve(r,t){let e={};if(!Array.isArray(r))return e;for(let a of t){let n=null,i=-1;for(let d of r){if(d?.chainId!=="solana"||!d?.pairAddress||d?.baseToken?.address!==a)continue;let l=Number(d?.liquidity?.usd)||0;l>i&&(i=l,n=d)}if(!n)continue;let p=Number(n.priceUsd),c=Number(n.priceChange?.h24);e[a]={priceUsd:Number.isFinite(p)&&p>0?p:null,change24hPct:Number.isFinite(c)?c:null,liquidityUsd:It(r,a)}}return e}async function Bt({mints:r,baseUrl:t=Ft,fetchImpl:e=globalThis.fetch,signal:a}={}){if(!Array.isArray(r)||r.length===0)return{stats:{},rows:[]};let n=await e(xe(r,t),{method:"GET",headers:{accept:"application/json"},signal:a});if(!n.ok)throw new Error(`stats ${n.status}`);let i=await n.json();return{stats:ve(i,r),rows:Array.isArray(i)?i:[]}}var Ht="preview",gt=Object.freeze({id:"global",label:"All markets"}),jt=Object.freeze(["No links","No wallet or contract addresses","No images","No direct messages"]),Gt=Object.freeze([Object.freeze({id:"connection",label:"System",body:"Market Chat is not connected in this build."}),Object.freeze({id:"approval",label:"System",body:"Posting remains closed until wallet sign-in, moderation, retention and privacy controls are separately approved."})]),We=Object.freeze(["spam","scam","manipulation","harassment","impersonation","privacy","threats","unlawful_content"]),Ye=Object.freeze(["quarantine","remove","restore","mute","ban","revoke_session","pause_posting"]),V=Object.freeze({title:"Market Chat",status:"Read-only design preview",rulesLabel:"Room rules",composerLabel:"Message",composerPlaceholder:"Posting is not available in this preview.",composerExplanation:"The composer is disabled. This preview makes no wallet, network or storage request.",submitLabel:"Post"});var dt=0;function N(r,t,e,a,n){let i=r.createElement(e);return a&&(i.className=a),n!==void 0&&(i.textContent=n),t.appendChild(i),i}function Qt({host:r}={}){let t=r?.ownerDocument;if(!r||typeof r.appendChild!="function"||!t?.createElement)throw new TypeError("A DOM host is required to mount read-only Market Chat.");dt+=1;let e=`rp-chat-title-${dt}`,a=`rp-chat-explanation-${dt}`,n=t.createElement("aside");n.className="rp-chat",n.setAttribute("data-chat-mode",Ht),n.setAttribute("aria-labelledby",e);let i=N(t,n,"header","rp-chat__header");N(t,i,"p","rp-chat__room",gt.label);let p=N(t,i,"h2","rp-chat__title",V.title);p.id=e,N(t,i,"p","rp-chat__status",V.status).setAttribute("role","status");let c=N(t,n,"div","rp-chat__log");c.setAttribute("role","log"),c.setAttribute("aria-label",`${gt.label} system notices`),c.setAttribute("aria-live","polite"),c.setAttribute("aria-relevant","additions text");for(let v of Gt){let x=N(t,c,"article","rp-chat__message rp-chat__message--system");x.setAttribute("data-system-state",v.id),N(t,x,"p","rp-chat__message-label",v.label),N(t,x,"p","rp-chat__message-body",v.body)}let d=N(t,n,"section","rp-chat__rules");d.setAttribute("aria-label",V.rulesLabel),N(t,d,"p","rp-chat__rules-label",V.rulesLabel),N(t,d,"p","rp-chat__rules-list",jt.join(" · "));let l=N(t,n,"div","rp-chat__composer");l.setAttribute("aria-disabled","true");let s=N(t,l,"label","rp-chat__composer-label",V.composerLabel),_=N(t,l,"textarea","rp-chat__composer-input");_.id=`rp-chat-input-${dt}`,_.disabled=!0,_.rows=2,_.maxLength=280,_.placeholder=V.composerPlaceholder,_.setAttribute("aria-describedby",a),s.setAttribute("for",_.id);let z=N(t,l,"p","rp-chat__composer-explanation",V.composerExplanation);z.id=a;let h=N(t,l,"button","rp-chat__submit",V.submitLabel);return h.type="button",h.disabled=!0,r.appendChild(n),Object.freeze({destroy(){n.remove()}})}var Kt="EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v";var ye=Object.freeze(["invalid_intent","unsupported_pair","no_route","rate_limited","schema_changed","network","unavailable","stale"]),Ze=Object.freeze({quote:!0,prepare:!1,sign:!1,submit:!1}),we="123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz",ke=new Map([...we].map((r,t)=>[r,t])),tr=Object.freeze(["taker","wallet","walletAddress","receiver","payer","referrer","referralAccount","referralFee","feeBps"]),C=class extends Error{constructor(t,e,{retryAfterMs:a=0,cause:n}={}){super(e,n===void 0?void 0:{cause:n}),this.name="ProQuoteError",this.code=ye.includes(t)?t:"unavailable",this.retryAfterMs=Number.isFinite(a)&&a>0?Math.floor(a):0}};function Ae(r){if(typeof r!="string"||r.length<32||r.length>44)return null;let t=[0];for(let a of r){let n=ke.get(a);if(n===void 0)return null;let i=n;for(let p=0;p<t.length;p+=1){let c=t[p]*58+i;t[p]=c&255,i=c>>8}for(;i>0;)t.push(i&255),i>>=8}let e=0;for(;e<r.length-1&&r[e]==="1";)e+=1;for(;e>0;)t.push(0),e-=1;return Uint8Array.from(t.reverse())}function Wt(r){return Ae(r)?.byteLength===32}function Yt(r,{positive:t=!0}={}){let e=typeof r=="bigint"?r.toString():typeof r=="string"?r:"";if(!/^(?:0|[1-9]\d*)$/u.test(e)||e.length>24)throw new C("invalid_intent","The exact input amount is invalid.");let a=BigInt(e);if(t&&a<=0n)throw new C("invalid_intent","The exact input amount must be positive.");return e}function Vt(r,t){let e=String(r??"").trim();if(!Number.isInteger(t)||t<0||t>18)throw new C("invalid_intent","The token precision is unsupported.");if(!/^(?:0|[1-9]\d*)(?:\.\d+)?$/u.test(e))throw new C("invalid_intent","Enter an ordinary decimal amount.");let[a,n=""]=e.split(".");if(n.length>t)throw new C("invalid_intent",`Use no more than ${t} decimal places.`);let i=`${a}${n.padEnd(t,"0")}`.replace(/^0+(?=\d)/u,"");return Yt(i||"0")}function bt(r,t,{trim:e=!0}={}){let a=Yt(r,{positive:!1});if(!Number.isInteger(t)||t<0||t>18)throw new C("schema_changed","The provider returned unsupported precision.");let n=a.padStart(t+1,"0"),i=t===0?n:n.slice(0,-t),p=t===0?"":n.slice(-t);return e&&(p=p.replace(/0+$/u,"")),p?`${i}.${p}`:i}var Xt=Object.freeze([{slug:"aries",name:"Aries",glyph:"♈",hue:"#DE8E79"},{slug:"taurus",name:"Taurus",glyph:"♉",hue:"#B9D4BE"},{slug:"gemini",name:"Gemini",glyph:"♊",hue:"#B29DD0"},{slug:"cancer",name:"Cancer",glyph:"♋",hue:"#B6D4E4"},{slug:"leo",name:"Leo",glyph:"♌",hue:"#E0A9B4"},{slug:"virgo",name:"Virgo",glyph:"♍",hue:"#B7D9B0"},{slug:"libra",name:"Libra",glyph:"♎",hue:"#D3A9DE"},{slug:"scorpio",name:"Scorpio",glyph:"♏",hue:"#B9DCE8"},{slug:"sagittarius",name:"Sagittarius",glyph:"♐",hue:"#E0B080"},{slug:"capricorn",name:"Capricorn",glyph:"♑",hue:"#C0DEA8"},{slug:"aquarius",name:"Aquarius",glyph:"♒",hue:"#AE8FC9"},{slug:"pisces",name:"Pisces",glyph:"♓",hue:"#A9D4C4"}]);function Se(r){if(!r||!Array.isArray(r.assets))throw new C("unavailable","The Registry is unavailable.");let t=new Map,e=new Set;for(let a of Xt){let i=r.assets.find(p=>p?.sign===a.slug)?.native;if(!i||i.chain!=="solana"||i.tokenStandard!=="SPL"||i.isCanonicalOrigin!==!0||i.isOfficialRepresentation!==!0||i.sign!==a.slug||i.decimals!==6||typeof i.address!="string"||!Wt(i.address)||i.address===Kt||e.has(i.address)||typeof i.symbol!="string")throw new C("unavailable",`The ${a.name} Registry record is invalid.`);t.set(a.slug,Object.freeze({...a,mint:i.address,decimals:i.decimals,symbol:i.symbol})),e.add(i.address)}if(t.size!==Xt.length)throw new C("unavailable","The Registry does not contain all twelve markets.");return t}async function Jt({fetchImpl:r=globalThis.fetch,url:t="/registry/zodiacs.registry.json",signal:e}={}){let a=await r(t,{headers:{accept:"application/json"},signal:e,cache:"no-store"});if(!a.ok)throw new C("unavailable",`The Registry could not be read (${a.status}).`);return Se(await a.json())}var Te=Object.freeze(["15m","1h","4h","1d"]),Zt=1e4,Ee=15e3;function o(r,t,e){let a=document.createElement(r);return t&&(a.className=t),e!==void 0&&(a.textContent=e),a}function at(r,t,e="button"){let a=o("button",r,t);return a.type=e,a}function _t(r,t){let e=new AbortController,a=!1,n=()=>e.abort(r?.reason);r?.aborted?n():r?.addEventListener("abort",n,{once:!0});let i=setTimeout(()=>{a=!0,e.abort(new DOMException("Request timed out.","TimeoutError"))},t);return{signal:e.signal,timedOut:()=>a,cleanup(){clearTimeout(i),r?.removeEventListener("abort",n)}}}function te(r){let t=Number(r);return Number.isFinite(t)?`${t>0?"+":""}${t.toFixed(2)}%`:"—"}function ee(r){let t=Number(r);return Number.isFinite(t)&&t>0?`$${D(t)}`:"—"}function Ce(r){return Array.isArray(r)&&r.length?r.join(" · "):"Route not disclosed"}function re(r,t){let e=Date.parse(String(r??""));return Number.isFinite(e)?new Intl.DateTimeFormat(void 0,{hour:"2-digit",minute:"2-digit",second:"2-digit"}).format(e):t}function Me(){try{return globalThis.localStorage??null}catch{return null}}function Ne(r){return{rate_limited:"Provider budget is cooling down.",no_route:"No route for this exact size.",stale:"The quote expired before it could be shown.",schema_changed:"Provider answer failed validation.",network:"Provider did not answer before the deadline.",unavailable:"Provider is unavailable."}[r]??"Quote unavailable."}function Re(r){if(r instanceof rt){if(r.code==="rate_limited")return"Provider rate limit — waiting before another read.";if(r.code==="not_indexed")return"This reference pool is not indexed."}return"Market data is unavailable just now."}function Oe(r,t){let e=at("rp-market");e.dataset.sign=r.slug,e.setAttribute("aria-pressed","false");let a=o("span","rp-market__glyph",r.glyph);a.setAttribute("aria-hidden","true");let n=o("span","rp-market__label");n.append(o("span","rp-market__name",r.name),o("span","rp-market__symbol",r.symbol));let i=o("span","rp-market__figures");return i.append(o("span","rp-market__price","Indexing…"),o("span","rp-market__change","24h —")),e.append(a,n,i),e.style.setProperty("--sign-hue",r.hue),e.addEventListener("click",()=>t(r.slug)),e}function Pe(r){let t=o("table","rp-tape__table"),e=o("caption","sr-only","Recent canonical-pool trades"),a=o("thead"),n=o("tr");for(let p of["Age","Side","Amount","Price","Value"])n.append(o("th",null,p));a.append(n);let i=o("tbody");return t.append(e,a,i),r.append(t),{set(p,c,d=Date.now()){i.replaceChildren(...p.slice(0,24).map(l=>{let s=o("tr",`rp-tape__row rp-tape__row--${l.side}`);return s.append(o("td",null,Mt(l.ts,d)),o("td","rp-tape__side",l.side==="buy"?"Buy":"Sell"),o("td",null,`${Ct(l.tokenAmount)} ${c.symbol}`),o("td",null,`$${D(l.priceUsd)}`),o("td",null,l.volumeUsd===null?"—":ht(l.volumeUsd))),s}))},clear(){i.replaceChildren()}}}function qe(r){let t=o("table","rp-chart-data__table"),e=o("thead"),a=o("tr");for(let i of["UTC","Open","High","Low","Close","Volume"])a.append(o("th",null,i));e.append(a);let n=o("tbody");return t.append(e,n),r.append(t),{set(i){n.replaceChildren(...i.map(p=>{let c=o("tr");return c.append(o("td",null,new Date(p.ts*1e3).toISOString()),o("td",null,D(p.o)),o("td",null,D(p.h)),o("td",null,D(p.l)),o("td",null,D(p.c)),o("td",null,D(p.v))),c}))},clear(){n.replaceChildren()}}}function De(r,t,e,a){let n=o("article","rp-quote"),i=r.provider==="jupiter"?"Swap V2 Meta-Aggregator · Ultra mode":"Raydium",p=o("div","rp-quote__head");if(p.append(o("strong",null,i)),t.highestQuotedOutputProvider===r.provider&&r.status==="ready"&&p.append(o("span","rp-badge","Highest quoted output")),n.append(p),r.status!=="ready")return n.classList.add("is-unavailable"),n.append(o("p","rp-quote__meta",Ne(r.error))),n;let c=r.quote,d=a==="buy"?e.symbol:"USDC",l=c.minimumOutput===null?"Minimum not reported":`Minimum ${bt(c.minimumOutput,6)} ${d}`,s=c.feeBps===null?"Fee not separately reported":`Reported fee ${c.feeBps} bps`,_=r.provider==="jupiter"?`Jupiter RTSE ${c.slippageBps} bps`:`Selected Raydium guard ${c.slippageBps} bps`;return n.append(o("div","rp-quote__amount",`${bt(c.outputAmount,6)} ${d}`),o("p","rp-quote__meta",[l,_,`Impact ${c.priceImpactPct??"not reported"}%`,s].join(" · ")),o("p","rp-quote__route",Ce(c.route)),o("p","rp-quote__meta",`Observed ${re(c.observedAt,"unknown")} · ${c.expiresAt?`expires ${re(c.expiresAt,"soon")}`:"15-second local freshness limit"}`)),n}function ze(r){let t=o("div","rp"),e=o("header","rp__topbar"),a=o("div");a.append(o("p","rp__eyebrow","Twelve markets · Phase 1"),o("h2","rp__title","Zodiac Markets"));let n=o("div","rp__badges");n.append(o("span","rp-badge is-ready","Read-only"),o("span","rp-badge","No wallet"),o("span","rp-badge","No submission")),e.append(a,n);let i=o("p","rp-status is-waiting","Reading the twelve official Registry markets…");i.setAttribute("role","status");let p=o("div","rp__rail");p.setAttribute("role","group"),p.setAttribute("aria-label","Zodiac Markets");let c=o("div","rp__workspace"),d=o("div","rp__market-column"),l=o("section","rp-panel rp-chart"),s=o("header","rp-panel__head"),_=o("h3","rp-panel__title","Reference-pool chart"),z=o("p","rp-panel__meta","Canonical pool · GeckoTerminal index"),h=o("div");h.append(_,z);let v=o("div","rp-chart__toolbar"),x=o("div","rp-timeframes");x.setAttribute("role","group"),x.setAttribute("aria-label","Chart timeframe");let L=at("rp-button rp-button--quiet","Refresh market data");L.setAttribute("aria-label","Refresh chart and recent trades"),v.append(x,L),s.append(h,v);let R=o("p","rp-chart__readout");R.id="rp-chart-readout";let Q=o("div","rp-chart__canvas"),O=o("canvas");O.setAttribute("role","img"),O.setAttribute("aria-label","Candlestick chart"),O.setAttribute("aria-describedby","rp-chart-readout rp-chart-state"),O.textContent="Candlestick chart. The same values are available in the candle data table.";let S=o("p","rp-chart__state is-waiting","Waiting for a reference pool…");S.id="rp-chart-state",S.setAttribute("role","status"),Q.append(O,S);let y=o("details","rp-chart-data");y.append(o("summary",null,"Candle data table"));let k=o("div","rp-chart-data__scroll");k.tabIndex=0,k.setAttribute("role","region"),k.setAttribute("aria-label","Candlestick values table"),y.append(k),l.append(s,Q,R,y);let j=o("section","rp-stats"),g=new Map;for(let[B,tt]of[["price","Indexed price"],["change","24h change"],["liquidity","Indexed liquidity"]]){let q=o("div","rp-stat"),ct=o("strong",null,"—");q.append(o("span",null,tt),ct),j.append(q),g.set(B,ct)}let f=o("section","rp-panel rp-tape"),E=o("header","rp-panel__head"),G=o("div");G.append(o("h3","rp-panel__title","Recent pool trades"),o("p","rp-panel__meta","Canonical pool only · not a consolidated tape")),E.append(G);let P=o("p","rp-status is-waiting","Waiting for a reference pool…");P.setAttribute("role","status");let U=o("div","rp-tape__scroll");U.tabIndex=0,U.setAttribute("role","region"),U.setAttribute("aria-label","Recent canonical-pool trades table"),f.append(E,P,U),d.append(l,j,f);let M=o("div","rp__side-column"),$=o("section","rp-panel rp-ticket"),K=o("header","rp-panel__head"),X=o("div");X.append(o("p","rp__eyebrow","Provider-neutral"),o("h3","rp-panel__title","Compare exact-input quotes")),K.append(X,o("span","rp-badge","Indicative"));let W=o("form","rp-ticket__form"),Z=o("div","rp-ticket__sides");Z.setAttribute("role","group"),Z.setAttribute("aria-label","Quote side");let nt=at("rp-button is-selected","Buy");nt.setAttribute("aria-pressed","true");let Y=at("rp-button","Sell");Y.setAttribute("aria-pressed","false"),Z.append(nt,Y);let lt=o("label","rp-ticket__field"),it=o("span",null,"You quote"),ot=o("span","rp-ticket__input"),I=document.createElement("input");I.name="amount",I.type="text",I.inputMode="decimal",I.autocomplete="off",I.value="25",I.setAttribute("aria-describedby","rp-quote-boundary");let st=o("span",null,"USDC");ot.append(I,st),lt.append(it,ot);let pt=o("label","rp-ticket__field");pt.append(o("span",null,"Raydium slippage guard"));let J=o("select","rp-ticket__select");J.name="slippageBps",J.setAttribute("aria-describedby","rp-slippage-boundary");for(let[B,tt]of[["25","0.25%"],["50","0.50%"],["100","1.00%"]]){let q=o("option",null,tt);q.value=B,B==="50"&&(q.selected=!0),J.append(q)}pt.append(J);let mt=o("p","rp-ticket__help","Raydium applies this fixed guard. Jupiter sets and reports its RTSE threshold independently.");mt.id="rp-slippage-boundary";let m=at("rp-ticket__button","Compare quotes","submit"),u=o("p","rp-ticket__status","Quotes run only when you ask. No wallet address is accepted.");u.id="rp-quote-boundary",u.setAttribute("role","status");let w=o("div","rp-ticket__quotes");W.append(Z,lt,pt,mt,m,u,w);let F=o("p","rp-ticket__attribution","Powered by Jupiter · Swap V2 Meta-Aggregator · Ultra mode"),A=o("div","rp-callout");A.append(o("strong",null,"Observation, not execution."),o("p",null,"Each provider answer is an expiring, quote-only snapshot. No transaction, request handle, wallet address, signature, or submission path reaches this page.")),$.append(K,F,W,A);let b=o("section","rp-panel rp-chat");M.append($,b),c.append(d,M);let T=o("p","rp-footnote","Reference-pool charts and aggregate-provider quotes answer different questions. Thin pools can move sharply; a later execution quote may differ.");return t.append(e,i,p,c,T),r.replaceChildren(t),{root:t,loading:i,rail:p,workspace:c,chartTitle:_,timeframes:x,refreshMarket:L,readout:R,canvas:O,chartState:S,candleTableHost:k,statNodes:g,tapeState:P,tapeHost:U,form:W,buy:nt,sell:Y,amount:I,amountText:it,amountUnit:st,slippage:J,submit:m,status:u,quoteHost:w,chatHost:b}}function ae({host:r,fetchImpl:t=globalThis.fetch,now:e=()=>Date.now(),storage:a=Me(),registryReader:n=Jt,statsReader:i=Bt,candleReader:p=Lt,tradesReader:c=Ut,chatFactory:d=Qt,chatEnabled:l=!1}={}){if(!r)throw new TypeError("Zodiac Markets requires a host.");let s=ze(r),_=Ot({canvas:s.canvas,readout:s.readout}),z=qe(s.candleTableHost),h=Pe(s.tapeHost);s.chatHost.hidden=!l;let v=null;if(l)try{v=d({host:s.chatHost})}catch{s.chatHost.replaceChildren(o("p","rp-status is-unavailable","Market Chat preview is unavailable."))}let x=qt({storage:a,now:e}),L=zt({storage:a,now:e}),R=new Map,Q={},O=[],S="aries",y="buy",k="1h",j=0,g=0,f=0,E=null,G=null,P=null,U=null,M=!1;function $(){return R.get(S)}function K(){for(let m of s.rail.querySelectorAll(".rp-market")){let u=m.dataset.sign===S;m.classList.toggle("is-selected",u),m.setAttribute("aria-pressed",u?"true":"false")}for(let m of s.timeframes.querySelectorAll(".rp-timeframe")){let u=m.dataset.timeframe===k;m.classList.toggle("is-selected",u),m.setAttribute("aria-pressed",u?"true":"false")}}function X(){let m=$(),u=m?Q[m.mint]:null;s.statNodes.get("price").textContent=ee(u?.priceUsd),s.statNodes.get("change").textContent=te(u?.change24hPct),s.statNodes.get("liquidity").textContent=Number.isFinite(u?.liquidityUsd)?ht(u.liquidityUsd):"—"}function W(){for(let m of s.rail.querySelectorAll(".rp-market")){let u=R.get(m.dataset.sign),w=u?Q[u.mint]:null;m.querySelector(".rp-market__price").textContent=ee(w?.priceUsd),m.querySelector(".rp-market__change").textContent=`24h ${te(w?.change24hPct)}`}X()}function Z(){s.timeframes.replaceChildren(...Te.map(m=>{let u=at("rp-timeframe",m);return u.dataset.timeframe=m,u.setAttribute("aria-pressed",m===k?"true":"false"),u.addEventListener("click",()=>{if(k===m)return;k=m;let w=$();w&&s.canvas.setAttribute("aria-label",`${w.name} / USDC ${k} candlestick chart`),K(),I({tapeToo:!1})}),u}))}function nt(){s.rail.replaceChildren(...[...R.values()].map(m=>Oe(m,lt))),K(),W()}function Y(m="Quotes run only when you ask. No wallet address is accepted."){f+=1,P?.abort(),P=null,clearTimeout(U),U=null,s.quoteHost.replaceChildren(),s.status.textContent=m,s.status.className="rp-ticket__status",s.submit.removeAttribute("aria-disabled"),s.submit.removeAttribute("aria-busy")}function lt(m){if(!R.has(m)||S===m)return;S=m;let u=$();s.chartTitle.textContent=`${u.name} / USDC`,s.canvas.setAttribute("aria-label",`${u.name} / USDC ${k} candlestick chart`),s.amountUnit.textContent=y==="buy"?"USDC":u.symbol,K(),X(),Y("Market changed. Request a new comparison when ready."),I({tapeToo:!0})}function it(m){if(y===m)return;y=m;let u=$();s.buy.classList.toggle("is-selected",y==="buy"),s.sell.classList.toggle("is-selected",y==="sell"),s.buy.setAttribute("aria-pressed",y==="buy"?"true":"false"),s.sell.setAttribute("aria-pressed",y==="sell"?"true":"false"),s.amountUnit.textContent=y==="buy"?"USDC":u?.symbol??"token",Y("Side changed. Request a new comparison when ready.")}async function ot(m,u,w,F,A,b){if(L.active()){A.textContent=`Provider cooling down for ${Math.ceil(L.remainingMs()/1e3)} seconds.`,A.className=A===s.chartState?"rp-chart__state is-waiting":"rp-status is-waiting";return}if(!x.take()){A.textContent="Shared market-data budget is resting. Try again in a minute.",A.className=A===s.chartState?"rp-chart__state is-waiting":"rp-status is-waiting";return}let T=L.token();try{let B=await m(u);if(M||w!==F())return;L.ok(T),b(B)}catch(B){if(B instanceof rt&&B.code==="rate_limited"&&L.fail(B.retryAfterMs),B?.name==="AbortError"||M||w!==F())return;A.textContent=Re(B),A.className=A===s.chartState?"rp-chart__state is-unavailable":"rp-status is-unavailable"}}function I({tapeToo:m=!0}={}){let u=$();if(!u)return;let w=$t({slug:u.slug,mint:u.mint,rows:O});j+=1;let F=j;E?.abort(),E=new AbortController;let A=g;if(m&&(g+=1,A=g,G?.abort(),G=new AbortController),_.clear(),z.clear(),m&&h.clear(),!w){s.chartState.textContent="No indexed reference pool is available for this market.",s.chartState.className="rp-chart__state is-unavailable",m&&(s.tapeState.textContent="Recent pool trades are not indexed.",s.tapeState.className="rp-status is-unavailable");return}s.chartState.textContent="Reading candles…",s.chartState.className="rp-chart__state is-waiting",ot(p,{pool:w,timeframe:k,fetchImpl:t,signal:E.signal},F,()=>j,s.chartState,b=>{_.set({candles:b,timeframe:k,hue:u.hue}),z.set(b),s.chartState.textContent=b.length?`${b.length} indexed candles`:"No candles in this interval.",s.chartState.className=b.length?"rp-chart__state is-ready":"rp-chart__state is-unavailable"}),m&&(s.tapeState.textContent="Reading recent pool trades…",s.tapeState.className="rp-status is-waiting",ot(c,{pool:w,mint:u.mint,fetchImpl:t,signal:G.signal},A,()=>g,s.tapeState,b=>{h.set(b,u,e()),s.tapeState.textContent=b.length?`${b.length} recent indexed trades`:"No recent indexed trades.",s.tapeState.className=b.length?"rp-status is-ready":"rp-status is-unavailable"}))}async function st(){let m=new AbortController,u=_t(m.signal,Zt);try{let w=await i({mints:[...R.values()].map(F=>F.mint),fetchImpl:t,signal:u.signal});if(M)return;Q=w.stats,O=w.rows,W()}catch{M||(s.loading.textContent="Registry identity is ready; indexed summary data is temporarily unavailable.")}finally{u.cleanup()}}async function pt(m){if(m.preventDefault(),s.submit.getAttribute("aria-disabled")==="true")return;let u=$();if(!u)return;let w;try{w=Vt(s.amount.value,6)}catch(b){s.status.textContent=b instanceof C?b.message:"Enter a valid amount.",s.status.className="rp-ticket__status is-unavailable";return}f+=1;let F=f;P?.abort(),P=new AbortController;let A=_t(P.signal,Ee);s.submit.setAttribute("aria-disabled","true"),s.submit.setAttribute("aria-busy","true"),s.quoteHost.replaceChildren(),s.status.textContent="Comparing independent provider snapshots…",s.status.className="rp-ticket__status is-waiting";try{let b=await t("/api/registry-pro-quotes",{method:"POST",headers:{"content-type":"application/json",accept:"application/json"},credentials:"same-origin",cache:"no-store",signal:A.signal,body:JSON.stringify({sign:u.slug,side:y,amount:w,slippageBps:Number(s.slippage.value)})}),T=await b.json().catch(()=>null);if(M||F!==f)return;if(!(b.ok||b.status===503&&T?.status==="unavailable")||!T||!Array.isArray(T.results)||T.sign!==u.slug||T.side!==y||!["complete","partial","unavailable"].includes(T.status)){let q=b.status===404?"The server-side quote pilot is disabled.":b.status===429?"The quote budget is cooling down.":"The quote comparison is unavailable.";throw new C(T?.error??"unavailable",q)}s.quoteHost.replaceChildren(...T.results.map(q=>De(q,T,u,y))),s.status.textContent=T.status==="complete"?"Both provider snapshots passed the quote-only contract.":T.status==="partial"?"Partial coverage: one provider passed the quote-only contract.":"Neither provider has a current quote. Their independent failure states are shown below.",s.status.className=T.status==="unavailable"?"rp-ticket__status is-unavailable":"rp-ticket__status is-ready";let tt=T.results.filter(q=>q.status==="ready").map(q=>{let ct=Date.parse(String(q.quote?.observedAt??T.observedAt??"")),xt=Date.parse(String(q.quote?.expiresAt??""));return Number.isFinite(xt)?xt:ct+15e3}).filter(Number.isFinite);tt.length&&(clearTimeout(U),U=setTimeout(()=>{!M&&F===f&&Y("Provider snapshots expired. Request a fresh comparison.")},Math.max(0,Math.min(...tt)-e())))}catch(b){if(M||F!==f||P?.signal.aborted)return;s.status.textContent=b instanceof C?b.message:A.timedOut()?"The quote comparison timed out.":"The quote comparison is unavailable.",s.status.className="rp-ticket__status is-unavailable"}finally{A.cleanup(),F===f&&(s.submit.removeAttribute("aria-disabled"),s.submit.removeAttribute("aria-busy"),P=null)}}async function J(){let m=_t(null,Zt);try{if(R=await n({fetchImpl:t,signal:m.signal}),M)return;Z(),nt();let u=$();s.chartTitle.textContent=`${u.name} / USDC`,s.canvas.setAttribute("aria-label",`${u.name} / USDC ${k} candlestick chart`),s.loading.textContent="Official Registry identity loaded. Provider observations remain independent.",s.loading.className="rp-status is-ready",await st(),M||I({tapeToo:!0})}catch{s.loading.textContent="The official Registry could not be validated. Quotes remain closed.",s.loading.className="rp-status is-unavailable",s.workspace.hidden=!0}finally{m.cleanup()}}return s.buy.addEventListener("click",()=>it("buy")),s.sell.addEventListener("click",()=>it("sell")),s.amount.addEventListener("input",()=>Y("Amount changed. Request a new comparison when ready.")),s.slippage.addEventListener("change",()=>Y("Raydium guard changed. Request a new comparison when ready.")),s.form.addEventListener("submit",pt),s.refreshMarket.addEventListener("click",async()=>{await st(),M||I({tapeToo:!0})}),{ready:J(),destroy(){M=!0,j+=1,g+=1,f+=1,E?.abort(),G?.abort(),P?.abort(),clearTimeout(U),_.destroy(),v?.destroy?.(),r.replaceChildren()}}}function Le(){if(document.querySelector("style[data-registry-pro-styles]"))return;let r=document.createElement("style");r.setAttribute("data-registry-pro-styles",""),r.textContent=vt,document.head.append(r)}function ne(){let r=document.querySelector("[data-registry-pro-terminal]");if(!(!r||r.dataset.registryProMounted)){r.dataset.registryProMounted="1",Le();try{let t=document.querySelector('meta[name="zodiacs-registry-pro-chat-enabled"][content="1"]')!==null;ae({host:r,chatEnabled:t})}catch{r.innerHTML="";let t=document.createElement("div");t.className="registry-pro__fallback",t.setAttribute("role","status"),t.textContent="Zodiac Markets could not open. No quote or transaction was sent.",r.append(t)}}}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",ne,{once:!0}):ne();})();
