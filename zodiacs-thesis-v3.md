...
- VII: ecological fallacy conceded inline; "millennial traders" attributed precisely; Cerulli scoped to purchasing power, allocation claim removed; "money is leaving the generation..." line DELETED; friction escape-hatch replaced with committed, dated, falsifiable test (placeholders — resolved by the Nº 06 closeout: preregistered in thesis-test.json)
...
- X: NEW disclosure section "The instrument, in the open" — operator-fillable placeholders; resolved by the Nº 06 closeout (values published, dated, baked static)
...
[CANDIDACY SCOREBOARD — reads thesis-candidacy.json; resolved values are also baked into the static rows]
...
[TEST COMMITMENT CARD — reads thesis-test.json; preregistered criteria are also baked into the static rows]
...
[INSTRUMENT TABLE — per sign and aggregate, values from thesis-disclosure.json, baked static and re-hydrated live. Columns:]
