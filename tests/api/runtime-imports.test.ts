...
const EXPECTED_HANDLERS = [
  ...
  'api/compatibility/invite-complete.ts',
  'api/compatibility/invite-exchange.ts',
  'api/compatibility/invite-hide.ts',
  'api/compatibility/invite-revoke.ts',
  'api/compatibility/invite-session.ts',
  'api/compatibility/invite-sweep.ts',
  'api/compatibility/invites.ts',
