...
- `disclosure.linkTradeExample`
  - EN default: `A sign’s catalogue page`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.operatorEvidence`
  - EN default: `Attested by the operator on 2026-08-02 and published verbatim; not independently verified. It supersedes the 2026-07-23 attestation, which did not address venue, referral, or marketplace compensation.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.tradeEvidence`
  - EN default: `The generated catalogue pages contain no wallet host, trade flag, trade runtime, transaction instructions, or venue deep-link. The full trading interface, where enabled, remains outside the catalogue.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.tradeStatement`
  - EN default: `Catalogue profiles contain no embedded trade panel, purchase route, or external venue link. They show public market context and verified token addresses only. Zodiacs.org never holds keys or funds, never builds, signs, or sends a transaction, and cannot reverse one. Zodiacs.org configures no referral account or platform fee and receives nothing from any trade.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `og.astrofolio.alt`
  - EN default: `Astrofolio: the collection of gold sculptures and official tokens for the twelve Zodiac signs.`
...
- `og.wing.kicker`
  ...
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `og.wing.subtitle`
  - EN default: `Gold sculptures, official records, and public market context.`
  - Usage: Location: build-time 1200×630 Open Graph/Twitter artwork and image alt text. Tone: restrained Cosmic Void editorial voice. Maximum: 120 visible characters.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `og.wing.title`
...
- `sharePositions.chartImagePrivacyDetails`
  - EN default: `This image includes the birth date, time, and place shown above. It does not include a name, coordinates, or chart link.`
  - Usage: Location: birth-chart positions-only sharing dialog and receiver. Tone: concise, privacy-aware, and non-clinical.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
