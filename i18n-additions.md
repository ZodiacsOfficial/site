...
TODO(i18n): translation handoff for 556 additive keys introduced by the Trust, Growth Infrastructure & SDK Expansion build. Every surface renders in all five locale rails; a pending locale currently receives the English fallback shown here.
...
- `disclosure.economicEvidence`
  - EN default: `No holdings attestation is present in the repository.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.economicStatement`
  - EN default: `Unverified: whether the operator holds positions in the twelve Registry assets remains pending a holdings attestation.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.operatorEvidence`
  - EN default: `No operator attestation is present in the repository.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.operatorStatement`
  - EN default: `Unverified: whether Zodiacs.org and Astrofolio share an operator remains pending operator attestation.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.originSlot`
  - EN default: `{sign} deploy transaction — pending`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional. Preserve placeholders exactly: {sign}.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `disclosure.originStatement`
  - EN default: `Deployment provenance must be evidenced per sign by the earliest on-chain deploy transaction.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
