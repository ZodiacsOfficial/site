...
- `disclosure.evidenceHeading`
  ...
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `disclosure.intro`
  - EN default: `This page separates facts supported by public evidence from statements supplied by the operator. An operator attestation is dated and labeled as an attestation; it is never presented as independently verified.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `disclosure.kicker`
