...
- `disclosure.adviceStatement`
  - EN default: `Registry records, market context, and Registry Aura are not financial advice or a solicitation to buy, sell, or hold an asset. Aura is a symbolic reflection, not a wallet score or price signal, and no purchase is required.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
...
- `disclosure.readOnlyStatement`
  - EN default: `The Registry lookup surfaces and @zodiacs/sdk are read-only. Registry Aura may connect to compatible wallet software only after a user click to obtain authorized public accounts; it uses one compatible address for the lookup and does not hold assets, request signatures or approvals, construct or submit transactions, or switch networks.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `disclosure.scope`
...
- `disclosure.separationStatement`
  - EN default: `The core astrology tools remain free, contain no advertising or cross-site trackers, and can be used without the Registry. Registry Aura is an optional cross-link that reads a saved chart and one public wallet record side by side; the wallet record does not alter the chart calculation.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
