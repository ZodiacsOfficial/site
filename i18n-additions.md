...
TODO(i18n): translation handoff for 562 additive keys introduced by the Trust, Growth Infrastructure & SDK Expansion build. Every surface renders in all five locale rails; a pending locale currently receives the English fallback shown here.
...
- `disclosure.metaDescription`
  - EN default: `Plain-language operator, economic-interest, provenance, read-only wallet-connection, Registry classification, and digital-asset risk disclosures.`
...
- `og.tools.today.kicker`
  ...
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `og.tools.today.sub`
  - EN default: `A personal daily focus drawn from the chart you chose for Today on this device.`
  - Usage: Location: build-time 1200×630 Open Graph/Twitter artwork and image alt text. Tone: restrained Cosmic Void editorial voice. Maximum: 120 visible characters.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
