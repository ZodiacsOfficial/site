...
- `disclosure.tradeEvidence`
  - EN default: `The panel is not yet enabled anywhere on the site; this row states its operating rules in advance. When the panel ships, its published page code and a live catalogue page make the rules checkable, and this row moves to verified from published materials.`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
- `disclosure.tradeLabel`
  - EN default: `Embedded trading interface`
  - Usage: Location: /disclosure/ and its Registry/About/Thesis disclosure links. Tone: dry, factual, and non-promotional.
  - Pending locales: none — explicit copy exists in EN, ES, PT, FR, and IT
