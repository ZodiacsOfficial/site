 ...
 * pool, 2026-08-09). Cancer and Sagittarius have no pinned pair and resolve
 * to the deepest indexed pool instead, the same rule the gallery card uses;
 * when nothing is indexed they stay honestly unavailable.
 */
