...
export function panelView({
  ...
  const view = {
    ...
    subheading: `Official ${sign.name} Zodiac · Registry-listed address`,
    venue: 'Optional tool',
    assetNote: `You are buying the fungible ${sign.name} token — not a physical item or a 1-of-1 NFT. Here, “official” only means its complete address is listed in the Zodiacs Registry; it is not government, regulator, wallet, or exchange approval.`,
