 ...
 * Void ramp, copied — not invented. `--tp-sign` is set per mount and, with
 * the aries pastel for severe states, is the only chroma in here: every
 * accent derives from it via color-mix. Warm Gilt is retired sitewide — no
 * gold hex may return to this file (scripts/trade-styles.test.mjs pins it).
 */
