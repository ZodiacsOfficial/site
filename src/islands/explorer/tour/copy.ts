...
const TOUR_COPY = {
  ...
  es: {
    ...
    planetsBody1: 'Cada disco es un planeta en su grado real. De Mercurio a Marte van rápido y se leen en clave personal; Júpiter y Saturno ponen los temas largos; los tres exteriores marcan generaciones.',
    ...
    wholeBody2: 'Guárdala y tu página de perfil calcula el año que tiene por delante — siempre en este dispositivo. El enlace para compartir lleva los datos dentro del propio enlace; nunca pasa por un servidor.',
