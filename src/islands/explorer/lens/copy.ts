...
export const LENS_CHROME = {
  ...
  fr: {
    ...
    progressedIntro: 'L’anneau extérieur représente ton thème progressé à aujourd’hui — un jour après la naissance correspond à une année de vie.',
    ...
    transitsLink: 'Parcours ce ciel dans le temps sur /transits/.',
    returnInstant: 'Instant de la révolution solaire',
    localTime: 'ton heure',
    noTimeNote: 'Calculé à partir d’un thème de midi — une heure de naissance exacte précise ces positions.',
