...
const PROFILES: Record<string, Profile> = {
  aries: {
    ...
    friendship: 'legami vivi, progetti spontanei e persone capaci di dire sì senza convocare un comitato',
    ...
    mars: 'un desiderio visibile, competitivo e poco paziente di fronte ai giri di parole', house: 'l’ambito in cui rivendichi autonomia, decisione e il diritto di provare',
  ...
  taurus: {
    ...
    friendship: 'legami affidabili, progetti ricchi di buon cibo, musica, ricordi e una presenza senza fretta',
  ...
  libra: {
    ...
    purpose: 'imparare che la vera pace a volte richiede una decisione scomoda',
    ...
    care: 'bellezza semplice, arte, relazioni riposanti e tempo da soli per ascoltare la propria voce',
  ...
  sagittarius: {
    ...
    friendship: 'legami viaggiatori, lunghi confronti, progetti improvvisati e persone che non temano di cambiare idea',
  ...
  capricorn: {
    ...
    care: 'ossa, sonno, limiti al lavoro, umorismo, riposo programmato e il permesso di non produrre',
  ...
  pisces: {
    ...
    care: 'sonno, acqua, musica, una solitudine gentile e limiti energetici di fronte alle persone esigenti',
...
const SEEDS: Record<string, GuideSeed> = {
  aries: {
    ...
    faq: [
      ...
      { q: 'Quale pianeta governa l’Ariete?', a: 'Marte, associato all’azione, al desiderio, al coraggio e al conflitto diretto.' },
    ],
  },
  taurus: {
    intro: [
