...
const it = {
  ...
  explorerControlsError: 'Il tema è pronto, ma non è stato possibile caricare le interpretazioni e i comandi. Controlla la connessione e riprova.',
