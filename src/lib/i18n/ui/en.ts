...
const en = {
    ...
    explorerControlsLoading: 'Loading chart controls…',
    explorerControlsError: 'Your chart is ready, but its controls could not load. Check your connection and try again.',
