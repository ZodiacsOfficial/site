...
const en = {
  ...
  localDateReferenceError: 'We couldn’t establish a calculation time within this local date. Check the date and place.',
    ...
    shareNote: 'The link carries the birth details you entered. They are not sent to us, but anyone who has the link can open it, including anyone it is forwarded to. The card is a 1080×1350 image drawn on your device.',
    ...
    dstGapNotice: 'That clock time was skipped when the clocks jumped forward, so it never quite existed — we shifted forward across the gap, the standard convention.',
