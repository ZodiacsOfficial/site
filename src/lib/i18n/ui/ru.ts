...
const ru = {
  ...
  explorerAngles: 'Углы',
  explorerControlsLoading: 'Загрузка элементов управления картой…',
  explorerControlsError: 'Карта готова, но её элементы управления не загрузились. Проверьте подключение и попробуйте снова.',
