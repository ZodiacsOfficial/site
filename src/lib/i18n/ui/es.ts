...
const es = {
    ...
    explorerControlsLoading: 'Cargando los controles de la carta…',
    explorerControlsError: 'Tu carta está lista, pero sus controles no se pudieron cargar. Comprueba tu conexión e inténtalo de nuevo.',
