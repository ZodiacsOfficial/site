...
const es = {
    ...
    chartWheelCompareMine: 'Comparar con la mía',
    chartWheelCompareAdd: 'Añadir mi carta para comparar',
  ...
  localDateReferenceError: 'No pudimos establecer una hora de cálculo dentro de esta fecha local. Comprueba la fecha y el lugar.',
    ...
    shareNote: 'El enlace incluye los datos de nacimiento que ingresaste. No se nos envían, pero cualquiera que tenga el enlace puede abrirlo, también alguien a quien se lo reenvíen. La imagen es de 1080×1350 y se dibuja en tu dispositivo.',
    ...
    explorerNoSelection: 'Sin selección',
    explorerAngles: 'Ángulos',
    explorerControlsLoading: 'Cargando las interpretaciones y los controles de la carta…',
    explorerControlsError: 'Tu carta está lista, pero sus interpretaciones y controles no se pudieron cargar. Comprueba tu conexión e inténtalo de nuevo.',
    ...
    chartReceiptDownload: "Descargar el registro del cálculo (.json)",
    chartReceiptPrivacy: "Este archivo contiene datos de nacimiento sensibles y datos de la carta. Mantenlo privado.",
    chartReceiptError: "No se pudo descargar el archivo. Inténtalo de nuevo.",
    chartReceiptUnavailable: "No hay un registro del cálculo disponible para esta carta.",
    ...
    dstGapNotice: 'Esa hora se saltó cuando se adelantaron los relojes, así que no existió exactamente — la movimos hacia adelante, la convención estándar.',
