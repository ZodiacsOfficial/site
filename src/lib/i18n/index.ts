...
export const UI = {
  ...
  es: {
    ...
    todayBySignPrompt: 'Toca tu signo solar para la lectura de hoy — calculada del cielo real, sin hora de nacimiento.',
    ...
    recordOneOfTwelve: 'también es uno de los Doce — un registro canónico en el registro.',
