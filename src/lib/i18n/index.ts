...
export const UI = {
  en: {
    ...
    dignityFall: 'fall',
    explorerHint: 'Tap any planet, sign, house, or aspect line to inspect it.',
    explorerLabel: 'Interactive birth chart. Arrow keys move between planets, Enter opens details, Escape clears.',
  ...
  es: {
    ...
    dignityFall: 'caída',
    explorerHint: 'Toca cualquier planeta, signo, casa o línea de aspecto para inspeccionarlo.',
    explorerLabel: 'Carta natal interactiva. Las flechas mueven entre planetas, Enter abre los detalles, Escape los cierra.',
