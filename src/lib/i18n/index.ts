import { SIGN_SLUGS, type Element, type Modality } from '../signs';
...
export const UI = {
  en: {
    ...
    shareNote: 'The link carries the birth details you entered - nothing is sent to us, so only people you hand it to can open it. The card is a 1080x1350 image drawn on your device.',
  ...
  es: {
    ...
    shareNote: 'El enlace incluye los datos de nacimiento que ingresaste - no se nos envía nada, así que solo las personas a quienes se lo des podrán abrirlo. La imagen es de 1080x1350 y se dibuja en tu dispositivo.',
...
export const SIGN_DATES_ES: Record<string, string> = {
  aries: '21 mar - 19 abr',
...
export const ELEMENT_LABEL_ES: Record<Element, string> = {
  fire: 'Fuego',
  earth: 'Tierra',
  air: 'Aire',
  water: 'Agua',
