...
export function dailyEmailPage(
  ...
  action?:
    | {
      ...
      label: string;
      decision?: string;
      secondary?: { label: string; decision: string };
    }
