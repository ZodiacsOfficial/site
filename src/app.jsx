      ...
      return (
        <footer className="zfooter zfooter--static">
          <div className="zfooter__inner">
            ...
            <section className="zfooter__language" aria-labelledby="runtime-footer-language-label">
              <span className="zfooter__label" id="runtime-footer-language-label">Language</span>
              <nav className="zfooter__locales" aria-label="Language">
            ...
            <div className="zfooter__colophon">
              <p className="zfooter__copyright">© 2026 Zodiacs.org</p>
    ...
    function Footer({ technical = false, pro = false }) {
      ...
      return (
        <>
          ...
          <SiteEnd tagline={pro ? 'Live market context, anchored to verified public records.' : 'The official public Registry of the Twelve.'} />
        </>
      );
    }
