...
export const EN = Object.freeze({
  ...
  'disclosure.operatorStatement': 'Zodiacs.org and Astrofolio share an operator. [OPERATOR TO CONFIRM EXACT WORDING]',
  'disclosure.operatorEvidence': 'No operator attestation is present in the repository. [OPERATOR TO CONFIRM]',
  'disclosure.economicLabel': 'Economic interest',
  'disclosure.economicStatement': 'The operator holds positions in the twelve Registry assets. [OPERATOR TO CONFIRM]',
  'disclosure.economicEvidence': 'No holdings attestation is present in the repository. [OPERATOR TO CONFIRM]',
  'disclosure.originLabel': 'Origin',
  'disclosure.originStatement': 'Deployment provenance must be evidenced per sign by the earliest on-chain deploy transaction. [OPERATOR TO SUPPLY TX LINKS]',
  ...
  'disclosure.originSlot': '{sign} deploy transaction — [OPERATOR TO SUPPLY TX LINK]',
  ...
  'disclosure.establishedPending': 'Earliest deploy provenance — [OPERATOR TO SUPPLY TX LINK]',
