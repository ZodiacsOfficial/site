...
export const EN = Object.freeze({
  ...
  'disclosure.tradeStatement': 'Catalogue profiles contain no embedded trade panel, purchase route, or external venue link. They show public market context and verified token addresses only. Zodiacs.org never holds keys or funds, never builds, signs, or sends a transaction, and cannot reverse one. Zodiacs.org configures no referral account or platform fee and receives nothing from any trade.',
  'disclosure.tradeEvidence': 'The generated catalogue pages contain no wallet host, trade flag, trade runtime, transaction instructions, or venue deep-link. The full trading interface, where enabled, remains outside the catalogue.',
