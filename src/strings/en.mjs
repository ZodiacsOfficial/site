...
export const EN = Object.freeze({
  ...
  'disclosure.operatorStatement': 'The operator attests (2026-08-02): “I personally control the zodiacs.org domain, repository, deployments, and the Registry content published there. I do not control astrofolio.xyz, its official channels, token deployment or administrative authorities, treasury, liquidity, or market activity. No person, account, or organization responsible for zodiacs.org also controls those Astrofolio surfaces. I hold positions in one or more Registry assets. No referral account, platform fee, or other compensation from Jupiter, any liquidity pool, or any marketplace is configured for zodiacs.org, and the site receives nothing from any trade reached through it.”',
  'disclosure.operatorEvidence': 'Attested by the operator on 2026-08-02 and published verbatim; not independently verified. It supersedes the 2026-07-23 attestation, which did not address venue, referral, or marketplace compensation.',
  ...
  'disclosure.tradeLabel': 'Trade panel',
  'disclosure.tradeStatement': 'When the trade panel is enabled, a sign’s catalogue page can offer a trade in place. The panel is Zodiacs.org’s own interface, but the trade is not: prices come from the public API of Jupiter, an independent venue; Jupiter builds the transaction; the visitor’s wallet software asks them to approve and sign it; and Jupiter submits it to the network. Zodiacs.org never holds keys or funds, never builds, signs, or sends a transaction, and cannot reverse one. Jupiter charges a fee of 0.10% on the trade. Zodiacs.org configures no referral account or platform fee and receives nothing from any trade.',
  'disclosure.tradeEvidence': 'The panel is not yet enabled anywhere on the site; this row states its operating rules in advance. When the panel ships, its published page code makes the rules checkable — the site holds no signing key and calls no write endpoint of its own — and this row moves to verified from published materials. The 0.10% figure is the fee Jupiter’s public order response reports; it is the venue’s, not the site’s.',
