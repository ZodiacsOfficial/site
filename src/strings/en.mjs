...
export const EN = Object.freeze({
  ...
  'disclosure.operatorStatement': 'The operator attests (2026-07-23): Astrofolio is a decentralized project with no central company or controlling group, and operating Zodiacs.org does not make this site’s operator the operator of Astrofolio, in the same way that running a Bitcoin website does not make one Bitcoin’s operator.',
  'disclosure.operatorEvidence': 'Attested by the operator on 2026-07-23 and published faithfully; not independently verified. No public record identifies the operators of either site, and this attestation does not name who maintains astrofolio.xyz or the Astrofolio channels.',
  'disclosure.economicLabel': 'Economic interest',
  'disclosure.economicStatement': 'The operator attests (2026-07-23) to holding positions in one or more of the twelve Registry assets; amounts are not published.',
  'disclosure.economicEvidence': 'Attested by the operator on 2026-07-23; not independently verified. The operator authorized a qualitative statement only: no assets enumerated, no wallets or amounts published, and no lockup, vesting, or disposal policy attested. Private holdings are not inferred from any wallet.',
