/**
 * Static, flag-off Zodiac Markets page.
 *
 * The page is intentionally useful without its terminal: it documents the
 * quote workspace's boundary, source-separation controls, and the twelve
...
<head>
  ...
  <title>Zodiac Markets · Zodiacs.org</title>
  <meta name="description" content="A professional quote workspace for comparing independent provider routes across the twelve verified Zodiac records." />
  ...
  <meta property="og:title" content="Zodiac Markets" />
  ...
  <script type="application/ld+json">
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 3, "name": "Zodiac Markets", "item": "https://zodiacs.org/registry/pro/" }
    ]
  }
  </script>
  ...
  <div class="pro-shell">
    <main id="main" tabindex="-1">
      <section class="pro-hero" aria-labelledby="registry-pro-title">
        <div>
          <p class="pro-hero__kicker">Professional quote workspace · controlled research</p>
          <h1 id="registry-pro-title">Zodiac Markets</h1>
      ...
      <section class="pro-section" aria-labelledby="registry-pro-controls">
        <div class="pro-section__head">
          ...
          <p class="pro-section__note">The workspace compares observations. A displayed quote is not an order, recommendation, or promise of execution.</p>
        </div>
      ...
      <section class="pro-risk" aria-labelledby="registry-pro-risk">
        ...
        <div class="pro-risk__copy">
          ...
          <p>Zodiac Markets has no execution capability. It does not connect a wallet, build a transaction, take custody, route an order, or receive compensation. Provider quotes are non-executable, can change before a later trade, and must be checked against the official Registry mint. On-chain transactions elsewhere are irreversible. Any future execution surface requires a separate owner decision. The name does not mean Zodiacs.org operates a market or exchange. <a href="/disclosure/">Disclosure</a> · <a href="/terms/">Terms</a> · <a href="/privacy/">Privacy</a>.</p>
        </div>
      </section>

      <footer class="pro-foot">
        <span>Zodiacs.org · Zodiac Markets · Quote-only pilot</span>
