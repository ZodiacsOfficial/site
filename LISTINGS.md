...
- Website: `https://zodiacs.org/` · per-sign page: `https://zodiacs.org/{sign}/`
...
2. Submit: website (`https://zodiacs.org/{sign}/`), the social links above,
...
- `sitemap.xml` already lists all 26 URLs; `llms.txt` / `llms-full.txt`
  cover AI crawlers.
- IndexNow: the site key file is deployed at the root
  ...
  curl -s -X POST https://api.indexnow.org/indexnow \
    ...
    -d '{"host":"zodiacs.org","key":"<key>","keyLocation":"https://zodiacs.org/<key>.txt","urlList":["https://zodiacs.org/","https://zodiacs.org/aries/", "…"]}'
  ```
