...
export function wingNavCss() {
  ...
  .wnav { pointer-events: auto; display: inline-flex; align-items: center; gap: 10px; height: 52px; padding: 0 10px 0 20px; border-radius: 999px; background: rgba(10,12,17,0.66); backdrop-filter: saturate(150%) blur(18px); -webkit-backdrop-filter: saturate(150%) blur(18px); border: 1px solid var(--hair-2, rgba(198,204,218,0.16)); box-shadow: inset 0 1px 0 rgba(238,241,247,0.06), 0 12px 32px -14px rgba(0,0,0,0.7); }
  ...
  @media (max-width: 819.5px) { .wnav__dim { display: none; } }
  .wnav__search { display: inline-grid; place-items: center; width: 34px; height: 34px; margin-left: -8px; border-radius: 999px; color: var(--ink-2, #C6CCDA); text-decoration: none; transition: color 200ms var(--ease, cubic-bezier(0.4,0,0.2,1)), background 260ms var(--ease, cubic-bezier(0.4,0,0.2,1)); }
  .wnav__search:hover { color: var(--ink, #EEF1F7); background: rgba(198,204,218,0.07); }
  @media (min-width: 820px) { .wnav__search { display: none; } }
