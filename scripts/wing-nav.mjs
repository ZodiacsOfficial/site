...
export function wingNavHtml({ includeSearch = true } = {}) {
  ...
  return `<div class="wnav-wrap">
    <nav class="wnav" aria-label="Primary" data-wnav>
      ...
      ${search}
      <a class="wnav__chip" href="/registry/" aria-current="page">Terminal</a>
  ...
  <div class="wnav-menu" id="wnav-menu" data-wnav-mobile hidden>
    <nav aria-label="Mobile">
      <div class="wnav-menu__group">
        ...
        <a class="wnav-menu__link wnav-menu__registry" style="--i:3" href="/registry/" aria-current="page"><span>Terminal</span><small>Markets, token records, and research</small></a>
      </div>
      <div class="wnav-menu__group">
