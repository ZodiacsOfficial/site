  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .card {
      position: relative;
      background:
        radial-gradient(120% 60% at 50% 0%, rgba(210,167,78,0.06), transparent 55%),
    ...
    .stage::after {
      ...
      background: linear-gradient(90deg, transparent 0%, rgba(210,167,78,0.55) 22%, rgba(210,167,78,0.55) 78%, transparent 100%);
      pointer-events: none; z-index: 0;
    }
    .stage img {
    ...
    .prov__item::before {
      ...
      box-shadow: 0 0 10px rgba(210,167,78,0.35);
    }
    .prov__era {
    ...
    .rec {
      border: 1px solid var(--hair-2);
      background: linear-gradient(180deg, rgba(210,167,78,0.03), transparent 40%), var(--surface);
    ...
    .copychip {
      ...
      background: rgba(210,167,78,0.04); color: var(--ink-2);
    ...
    .market {
      ...
      background: linear-gradient(180deg, rgba(210,167,78,0.025), transparent 62%), rgba(14,10,7,0.52);
    }
    .market::after {
    ...
    .acq__note a { color: var(--ink-dim); text-decoration: none; border-bottom: 1px solid rgba(210,167,78,0.22); }
    ...
    .nextlot a:hover { background: rgba(210,167,78,0.05); }
      ...
      <aside class="market" data-market>
        <div class="market__head">
          <div>
            ...
            <p class="market__copy">Each rendered Zodiac detail view may show optional third-party market context from Dex Screener when a Solana pair record is configured. This context may be delayed or unavailable and never changes the registry, identity, or verification status of a sign.</p>
          </div>
