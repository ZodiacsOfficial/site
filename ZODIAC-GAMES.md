...
| P0.2 analytics | pending | — | — | v2.1 event set · scope reduced by P0.1: extend `src/lib/analytics-config.mjs` allowlist + verify events fire |
| R1.1 voice + product copy | **done** | 2026-08-16 | — | delivered as `claude/zodiacs-games-copy.md` |
| R1.2 Race MVP | pending | — | — | includes season countdown + simple trophy state |
| R1.3 share cards | pending | — | — | weekly + champion cards |
| R2.1 repoint ramps | pending | — | — | homepage/sign/tool routes |
